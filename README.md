...
├── Final Report.pdf               # Updated report after peer review comments
├── late_comparison_capstone.pdf   # Full written report (before peer review)
...
The script prints four plots directly to the console. 
